...
fscreen = Image.open("C:/SBI/img/fscreen.png") . resize((25, 25), Image.ANTIALIAS)
sbi_logo = Image.open("C:/SBI/img/sbi_logo.png") . resize((280, 180), Image.ANTIALIAS)
pers_bnk = Image.open("C:/SBI/img/pers_bankng.JPG") . resize((270, 88), Image.ANTIALIAS)
corp_bnk = Image.open("C:/SBI/img/corp_bankng.JPG") . resize((388, 103), Image.ANTIALIAS)
lgn = Image.open("C:/SBI/img/login.JPG") . resize((138, 38), Image.ANTIALIAS)
rgstr = Image.open("C:/SBI/img/register.JPG") . resize((163, 51), Image.ANTIALIAS)
c_care = Image.open("C:/SBI/img/cust_care.JPG") . resize((165, 55), Image.ANTIALIAS)
hlp = Image.open("C:/SBI/img/help.JPG") . resize((133, 53), Image.ANTIALIAS)
m_lk = Image.open("C:/SBI/img/more_links.JPG") . resize((168, 42), Image.ANTIALIAS)
bck = Image.open("C:/SBI/img/back.png") . resize((60, 40), Image.ANTIALIAS)
capcha1 = Image.open("C:/SBI/img/captcha/1.jpg") . resize((150, 53), Image.ANTIALIAS)
capcha2 = Image.open("C:/SBI/img/captcha/2.jpg") . resize((150, 53), Image.ANTIALIAS)
capcha3 = Image.open("C:/SBI/img/captcha/3.jpg") . resize((150, 53), Image.ANTIALIAS)
rld = Image.open("C:/SBI/img/reload.jpg") . resize((20, 20), Image.ANTIALIAS)
lgn_wlc = Image.open("C:/SBI/img/welc.jpg") . resize((1400, 40), Image.ANTIALIAS)
rnd_pic1 = Image.open("C:/SBI/img/banner11.jpg") . resize((700, 380), Image.ANTIALIAS)
rnd_pic2 = Image.open("C:/SBI/img/prec.jpg") . resize((1400, 200), Image.ANTIALIAS)
rnd_pic3 = Image.open("C:/SBI/img/inst_login.jpg") . resize((700, 50), Image.ANTIALIAS)
prof_bg = Image.open("C:/SBI/img/prof_bg.jpg") . resize((1600, 900), Image.ANTIALIAS)
ishaan_dp = Image.open("C:/SBI/img/ishaan.jpg") . resize((150, 150), Image.ANTIALIAS)
pmts = Image.open("C:/SBI/img/pay1.png") . resize((296, 191), Image.ANTIALIAS)
dpst = Image.open("C:/SBI/img/deposit1.png") . resize((296, 191), Image.ANTIALIAS)
lns = Image.open("C:/SBI/img/loans1.png") . resize((296, 191), Image.ANTIALIAS)
bnnr1 = Image.open("C:/SBI/banners/banner1.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr2 = Image.open("C:/SBI/banners/banner2.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr3 = Image.open("C:/SBI/banners/banner3.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr4 = Image.open("C:/SBI/banners/banner4.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr5 = Image.open("C:/SBI/banners/banner5.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr6 = Image.open("C:/SBI/banners/banner6.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr7 = Image.open("C:/SBI/banners/banner7.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr8 = Image.open("C:/SBI/banners/banner8.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr9 = Image.open("C:/SBI/banners/banner9.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr10 = Image.open("C:/SBI/banners/banner10.jpg") . resize((1200, 300), Image.ANTIALIAS)
bnnr11 = Image.open("C:/SBI/banners/banner11.jpg") . resize((1200, 300), Image.ANTIALIAS)
